...
<html>
    ...
    <body>
		...
		<br>
		  ...
		  <button onclick = "tabledisplay()">Click Here</button><br><br>
		<table border = 1 id = 'table'>
			    <th>"Booking ID"</th><th>"Payment Amount"</th><th>"Date of the Payment"</th><th>"Method of payment supposed to be done"</th>
			    <tr>
			    <td>"2"</td>
			    <td>"BookingID1"</td>
			    <td>"BookingID2"</td>
			...
			<p class="para4"><b>C<b> 2021-ApeX  Pvt.Ltd.All Rights Reserved </p>
